...
var DropzoneS3Uploader = (function (_React$Component) {
  ...
  _createClass(DropzoneS3Uploader, null, [{
    ...
    value: {
      ...
      aclPermissions: _propTypes2['default'].oneOf(['private', 'public-read', 'public-read-write', 'aws-exec-read', 'authenticated-read', 'bucket-owner-read', 'bucket-owner-full-control', 'log-delivery-write']),
